...
* The original package name 'br.com.marcos.fernandes.aula-teste' is invalid and this project uses 'br.com.marcos.fernandes.aulateste' instead.
...
```
$ docker run --rm -p 8080:8080 aula-teste:0.0.1-SNAPSHOT
```
